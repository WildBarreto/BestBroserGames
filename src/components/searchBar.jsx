...
export function SearchBar() {
  return (
    <div className="mx-auto flex flex-row justify-between h-16 items-center bg-slate-900">
      ...
      <button className="bg-lime-300 rounded-md mr-10 w-20 h-8 text- font-semibold hover:bg-lime-500">Login</button>
    </div>
  );
}
